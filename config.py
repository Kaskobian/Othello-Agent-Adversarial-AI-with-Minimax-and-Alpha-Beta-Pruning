...
DEFAULT_DMAX = 8  # maximum search depth
TIME_LIMIT = 30
DMAX = 8

# Evaluation weights (from your specification)
WEIGHTS = {
    "material": 10,   # Disc differential
    "mobility": 7,    # Legal moves differential
    "corner": 40,     # Corner control (most important)
    "edge": 3,        # Edge occupancy
    "stability": 4    # Stability proxy
}
